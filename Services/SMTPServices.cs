...
namespace study4_be.Services
{
    public class SMTPServices
    {
        ...
        public string GenerateCodeByEmailContent(string username, string orderDate, string orderId, string nameCourse, string codeActiveCourse)
        {
            ...
            sb.AppendLine("<img src='https://firebasestorage.googleapis.com/v0/b/estudy-426108.appspot.com/o/logoEStudy.svg?alt=media&token=68c17ef6-6430-414d-b265-8cc60257ca5f' alt='Logo' width='150'/>");
            sb.AppendLine("</div>");
